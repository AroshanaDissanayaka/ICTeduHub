...
<head>
  <meta charset="utf-8">
  <title>Ravidu Bandaranayake | Register</title>
  <?php
            ...
            <div>
              <div class="row clearfix">
                ...
                <div class="form-group col-lg-6 col-md-12 col-sm-12">
                  ...
                  <input type="text" name="username" id="fname" value="" placeholder="First Name" required>
                </div>

                <!-- Form Group -->
                <div class="form-group col-lg-6 col-md-12 col-sm-12">
                  <label>Last Name</label>
                  <input type="text" name="username" id="lname" value="" placeholder="Last Name" required>
                </div>

                <!-- Form Group -->
                <div class="form-group col-lg-6 col-md-12 col-sm-12">
                  <label>Email Address</label>
                  <input type="email" name="email" id="email" value="" placeholder="example@gmail.com" required>
                </div>

                <!-- Form Group -->
                <div class="form-group col-lg-6 col-md-12 col-sm-12">
                  <label>Phone Number</label>
                  <input type="text" name="phone" id="phone" value="" placeholder="000 000 0000" required>
                </div>
                ...
                <div class="form-group col-lg-6 col-md-12 col-sm-12">
                  ...
                  <span class="eye-icon flaticon-eye"></span>
                  <input type="password" name="password" id="cpassword" value="" placeholder="Password" required>
                </div>
